...
with app.app_context():
    ...
    # new_user1 = User(email='brussell@example.com', name='Russell Rick', password=password)
    ...
    new_category_user2 = Category(user_id=new_user2.user_id, name='Electronics', percent=30.0, timestamp=datetime.datetime(2023, 11, 3))
    new_category2_user2 = Category(user_id=new_user2.user_id, name='Dining Out', percent=40.0, timestamp=datetime.datetime(2023, 11, 3))
    new_category3_user2 = Category(user_id=new_user2.user_id, name='Entertainment', percent=30.0, timestamp=datetime.datetime(2023, 11, 3))
