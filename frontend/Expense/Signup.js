...
export default function Signup({navigation}) {
  ...
  function handleSubmit() {
    ...
    if (email.length < 1 || password.length < 1 || name.length < 1 || categories.length < 1 || budget < 1 || !validateEmail(email)) {
        toast.show("Please fill all inputs and use a valid email ending in .com or .edu", {
          type: "danger",
          placement: "top",
          duration: 4000,
          offset: 30,
    ...
    if(percentTotal !== 100) {
        toast.show("All percentages in the categories section must add up to 100", {
          type: "danger",
          placement: "top",
          duration: 4000,
          offset: 30,
      ...
      <View style={styles.container}>
        ...
        <View style={styles.infoCard}>
          ...
          {formData.categories.map((category, idx) => {
            return (
              <View style={styles.horizontalContainer} key={idx}>
                <TextInput
                  inputMode="text"
                  ...
                  autoCorrect={false}
                  autoCapitalize="none"
                  onChangeText={(value) => {handleCategoryChange(idx, "name", value)}}
                ...
                <TextInput
                  ...
                  autoCorrect={false}
                  autoCapitalize="none"
                  onChangeText={(value) => {handleCategoryChange(idx, "amount", value)}}
